...
This YAML configuration defines an Argo CD Application named "bgd-helm" that deploys a Helm chart from a specific Git repository to the "user%USERNUM%-bgdh" namespace.
